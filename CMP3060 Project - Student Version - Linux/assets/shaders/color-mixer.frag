...
void main(){
    ...
    vec4 inputColor = vec4(fs_in.color, 1.0);

    frag_color.r = dot(red, inputColor);
    frag_color.g = dot(green, inputColor);
    frag_color.b = dot(blue, inputColor);
    frag_color.a = 1.0; // Fully opaque
}